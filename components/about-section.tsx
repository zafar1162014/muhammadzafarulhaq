				...
				<div className="grid lg:grid-cols-2 gap-12">
					<div className="space-y-6 glass-surface p-6 md:p-8">
						<p className="text-muted-foreground leading-relaxed">
							I am a Machine Learning aspirant specializing in building
							predictive models and implementing data-driven solutions. I have
							delivered 5+ production-ready AI projects including sentiment
							analysis, traffic sign classification, and resume parsing systems,
							achieving up to 98% accuracy.
						</p>
						<p className="text-muted-foreground leading-relaxed">
							My expertise spans supervised learning, feature engineering, model
							evaluation, and hyperparameter tuning using Scikit-Learn,
							TensorFlow, and XGBoost. I excel at transforming raw data into
							clean datasets, extracting meaningful features, and optimizing
							model performance for real-world deployment.
						</p>
						<p className="text-muted-foreground leading-relaxed">
							I have hands-on experience with CNNs for computer vision, NLP for
							text classification, and transformer architectures (BERT, GPT-2)
							for conversational AI. I also worked on object detection research
							using YOLO, published on ResearchGate 2024.
						</p>
						<p className="text-muted-foreground leading-relaxed">
